...
const SignUpPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter overflow-hidden rounded-xl"
    >
      <div className="p-8">
        ...
        <form onSubmit={handleSignUp}>
          ...
          <motion.button
            className="mt-5 w-full py-3 px-4 bg-gradient-to-r from-purple-500 to-violet-600 text-white
                      font-bold rounded-lg shadow-lg hover:from-purple-600 hover:to-violet-700 
