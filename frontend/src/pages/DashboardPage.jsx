...
const DashboardPage = () => {
  ...
  return (
    ...
    >
      <h2
        className='text-3xl font-bold mb-6 text-center bg-gradient-to-r from-purple-500 to-violet-500
      ...
      >
        <motion.button
          ...
          className='w-full py-3 px-4 bg-gradient-to-r from-purple-500 to-violet-600 text-white font-bold rounded-md
                    shadow-lg hover:from-purple-600 hover:to-violet-700
                    focus:outline-none focus:ring-2 focus:bg-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900'
        >
          Logout
        </motion.button>
      </motion.div>
