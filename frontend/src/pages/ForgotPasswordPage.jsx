...
const ForgotPasswordPage = () => {
  ...
  return (
    ...
    >
        <div className="p-8">
            <h2 className="text-3xl font-bold text-center mb-6 bg-gradient-to-r from-purple-400 to-violet-500
            ...
            { !isSubmitted ? (
                <form onSubmit={handleSubmit}> 
                    ...
                    />
                    <motion.button
                        className="w-full py-3 px-4 bg-gradient-to-r from-purple-500 to-violet-600
                        text-white font-bold rounded-lg shadow-lg
                        hover:from-purple-600 hover:to-violet-700 focus:outline-none focus:ring-2
        ...
        <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
            <Link to={"/login"} className="text-sm text-purple-400 hover:underline flex items-center">
                <ArrowLeft to={"/login"} className="h-4 w-4 mr-2" /> Back to Login
            </Link>
        </div>
    </motion.div>
  )
